...
| 任务 | 说明 | 状态 |
|------|------|------|
| 记忆云端同步（已登录用户） | 跨设备留存 | ✅ 完成（2026-07-27） |
| 社区智囊生态打磨 | 市集推荐位 + UGC护城河 | ✅ 完成（2026-07-27） |
| 移动端适配 | 响应式布局（AppNav移动菜单/Game侧边栏命牌浮层自适应） | ✅ 完成（2026-07-27） |
| SEO优化 | robots.txt/sitemap.xml/JSON-LD结构化数据/meta标签/首屏骨架屏 | ✅ 完成（2026-07-27） |
| ErrorBoundary全路由覆盖 | 11个路由都加错误边界，单页崩溃不影响整站 | ✅ 完成（2026-07-27） |
| 可访问性基础 | aria-label/键盘导航/role属性 | ✅ 完成（2026-07-27） |
