...
export async function createDestinyCardCopy(input = {}, options = {}) {
  ...
  const prompt = [
    ...
    '只输出 JSON：{"verse":"不超过28字的两句短句","verdict":"不超过42字的判断","insight":"不超过24字的洞见","nextAction":"不超过24字的下一步","guardrail":"不超过24字的改路条件"}。',
  ...
  try {
    ...
    ], { maxTokens: 220, temperature: 0.55, timeout: 20000, stage: 'destiny_copy' });
