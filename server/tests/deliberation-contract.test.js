...
test('execute response always exposes one stable shape', () => {
  ...
  assert.deepEqual(Object.keys(response).sort(), [
    ...
    'gaps', 'interruption', 'masterSummary', 'oracle', 'reason', 'replanned', 'sessionId', 'state',
    'lensImpacts', 'lensReview', 'contributionGate', 'advisorFailures', 'affectedAdvisorIds', 'plan',
  ].sort());
